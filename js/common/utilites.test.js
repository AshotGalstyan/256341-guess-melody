...
describe(`Game functions`, () => {
  ...
  describe(`compareScores`, () => {
    it(`Valid`, () => {
      assert.equal(compareScores(10, [11, 8, 5, 4]), `Вы заняли 2 место из 5 игроков.<br>Это лучше, чем у 60% игроков.`);
      assert.equal(compareScores(12, [11, 8, 5, 4]), `Вы заняли 1 место из 5 игроков.<br>Это лучше, чем у 80% игроков.`);
      assert.equal(compareScores(2, [11, 8, 5, 4]), `Вы заняли последнее место из 5 игроков.<br>Это худший результат.`);
    });
  });
});
